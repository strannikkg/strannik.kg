...
function slowScroll(t){return $("html, body").animate({scrollTop:$(t).offset().top-50},1e3),!1}function growDiv(){var t=document.getElementById("grow");if(t.clientHeight)t.style.height=0;else{document.querySelector(".bk_content");t.style.height="auto"}document.getElementById("more_button").value="Читать онлайн"==document.getElementById("more_button").value?"Скрыть содержание":"Читать онлайн"}$((function(){$(".example-video").youtubeVideo(),$("#owl_gallery_guide").owlCarousel({loop:!1,margin:3,nav:!1,dots:!1,autoplay:!1,autoHeight:!1,lazyLoad:!0,responsive:{0:{items:5}}}),$("#owl_news_home").owlCarousel({loop:!1,margin:10,nav:!0,navText:["<span class='iconify' data-icon='mdi-light:chevron-left' data-inline='false'></span>","<span class='iconify' data-icon='mdi-light:chevron-right' data-inline='false'></span>"],dots:!1,autoplay:!1,autoHeight:!1,lazyLoad:!0,responsive:{0:{items:1},600:{items:2},992:{items:3}}}),$("#owl_guide").owlCarousel({loop:!1,margin:10,nav:!0,navText:["<span class='iconify' data-icon='mdi-light:chevron-left' data-inline='false'></span>","<span class='iconify' data-icon='mdi-light:chevron-right' data-inline='false'></span>"],dots:!1,autoplay:!1,autoHeight:!1,lazyLoad:!0,responsive:{0:{items:1},420:{items:2},640:{items:3},920:{items:4},1200:{items:5}}}),$(window).scroll((function(){$(this).scrollTop()>100?$("#back_to_top").fadeIn():$("#back_to_top").fadeOut()})),$("#back_to_top").click((function(){return $("body,html").animate({scrollTop:0},800),!1})),$("table").wrap('<div class="table_adaptive"></div>')})),$((function(){$(".content img").each((function(){var t=$(this),e=t.attr("alt");e&&(t.attr("class","figure_img_images"),t.wrap('<figure class="figure_img">'),t.after('<figcaption class="figure_img_alt">'+e+"</figcaption>"),t.wrap('<a class="image-popup-no-margins" href="'+$(this).attr("src")+'" title="'+$(this).attr("alt")+'">'))}))})),$((function(){$(".header_article_image img").each((function(){var t=$(this);t.attr("alt")&&(t.attr("class","figure_img_images"),t.wrap('<figure class="figure_img">'),t.wrap('<a class="image-popup-no-margins" href="'+$(this).attr("src")+'" title="'+$(this).attr("alt")+'">'))}))})),$(document).ready((function(){$(".gallery_guide").magnificPopup({delegate:"a",type:"image",closeOnContentClick:!1,closeBtnInside:!1,mainClass:"mfp-with-zoom mfp-img-mobile",tLoading:"",image:{tError:'<a href="%url%">The image #%curr%</a> could not be loaded.',verticalFit:!0,titleSrc:function(t){return t.el.attr("title")}},gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1]},zoom:{enabled:!0,duration:300,opener:function(t){return t.find("img")}}}),$(".gallery_tour").magnificPopup({delegate:"a",type:"image",closeOnContentClick:!0,closeBtnInside:!1,tLoading:"",mainClass:"mfp-with-zoom mfp-img-mobile",image:{verticalFit:!0,tError:'<a href="%url%">Это изображение #%curr%</a> не может быть отображено.',titleSrc:function(t){return t.el.attr("title")+"<small>Фото из архива турклуба Странник</small>"}},gallery:{enabled:!0},zoom:{enabled:!0,duration:300,opener:function(t){return t.find("img")}},callbacks:{beforeChange:function(){this.items[0].src=this.items[0].src+"?="+Math.random()}}}),$(".simple-ajax-popup").magnificPopup({type:"ajax"}),$(".image-popup-no-margins").magnificPopup({type:"image",closeOnContentClick:!0,closeBtnInside:!1,fixedContentPos:!0,mainClass:"mfp-no-margins mfp-with-zoom",image:{verticalFit:!0},zoom:{enabled:!0,duration:300}})})),$((function(){var t;$("body").on("click",'[href*="#"]',(function(t){$("html, body").stop().animate({scrollTop:$(this.hash).offset().top-50},1e3),t.preventDefault()}));var e=1,a=$("#ogl"),i=$('<div class="ogl_title">Оглавление</div>');a.append(i);var o=window.location.href.replace(window.location.hash,"");void 0!==a&&$(".content h1, .content h2, .content h3, .content h4").each((function(i){var n=$(this);for(n.attr("id","title"+i),t=parseInt(n.prop("tagName").substring(1));t>e;e++){var l=$("<ul></ul>");if(1==e)a.append(l);else $("#ogl li").last().append(l);t>e+1&&l.append('<li style="list-style-type: none"></li>'),a=l}for(;t<e;)a=a.parent().parent(),e--;curder=n.html(),":"==curder.charAt(curder.length-1)&&(curder=curder.substr(0,curder.length-1)),a.append("<li><a id='link"+i+"' itemprop='url' href='"+o+"#title"+i+"' title='"+n.html()+"'>"+curder+"</a></li>")}))})),$((function(){$("[data-mrc]").moreContent({shadow:!0}),$("[data-ft]").flexTabs({fade:500}),$(".accordion_faq").flexTabs({theme:"ft_theme_faq",type:"accordion",fade:300,icon:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"><path d="M48.293 23.293l-16.293 16.293-16.293-16.293-1.414 1.561 17 17.146h1.414l17-17.146z"/></svg>',collapsible:!0}),$(".accordion_ogl").flexTabs({theme:"ft_theme_default",type:"accordion",fade:200,collapsible:!0}),$(".info_icon").tipTip({maxWidth:"275px",edgeOffset:1,delay:0,fadeIn:200,fadeOut:200,defaultPosition:"top"})}));
$(document).ready((function(){$(".menu > ul > li:has( > ul)").addClass("menu-dropdown-icon"),$(".menu > ul > li > ul:not(:has(ul))").addClass("normal-sub"),$(".menu > ul").before('<a href="/" class="menu-mobile"></a>'),$(".menu > ul > li").hover((function(l){$(window).width()>943&&($(this).children("ul").slideDown(300),l.preventDefault())}),(function(l){$(window).width()>943&&($(this).children("ul").slideUp(100),l.preventDefault())})),$(document).on("click",(function(l){0===$(l.target).parents(".menu").length&&$(".menu > ul").removeClass("show-on-mobile")})),$(".menu > ul > li").click((function(){var l=$(this).children("ul"),n=l.css("display");$(".menu > ul > li > ul").slideUp(),$(window).width()<943&&"block"!==n&&l.slideDown()})),$(".menu-mobile").click((function(l){$(".menu > ul").toggleClass("show-on-mobile"),l.preventDefault()}))}));
$(document).ready((function(){$(".sisea-search-form input").keyup((function(){this.value.length>3?($(document).click((function(s){$(s.target).closest(".site-search-results").length||$(".site-search-results").slideUp("fast")})),$("#site-search-results").append('<span id="load">LOADING...</span>'),$("#load").fadeIn("normal"),$("#search").click((function(){return $(".site-search-results").slideDown("fast"),!1})),$("#site-search-results").load("/ajaxsearch",$(".sisea-search-form").serialize()).slideDown("fast")):$("#site-search-results").slideUp("fast")}))}));
/**
 * Owl carousel
 * @version 2.3.4
